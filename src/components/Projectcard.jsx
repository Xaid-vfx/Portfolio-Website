        ...
        <>
            ...
            <div className='full'>
                ...
                <div className='prodesc' id='prodesc1'>
                    ...
                    <p><small>The objective of this project was to create a Full-Stack Web app using ReactJS and Firebase</small></p> The project displays a list of recipes displayed from the firebase database
                    <br />
            ...
            <div className='full'>
                ...
                {window.screen.availWidth > 760 ?
                    (<div className='project project2' id='project2'>
                        <h4>Spotify</h4>
